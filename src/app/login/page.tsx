  ...
  return (
    <div className="min-h-screen bg-[#fcfcfc] flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-[#464646]">Welcome Back</h1>
          <p className="text-[#bebebf] mt-2">Sign in to your account</p>
        </div>
    ...
    Forgot password?
          ...
          <p className="mt-6 text-center text-sm text-[#bebebf]">
            ...
            <Link href="/signup" className="text-[#fcc425] hover:underline font-semibold">
              Sign up
            </Link>
          </p>
        </div>
